...
public class fav_grid_view extends AppCompatActivity {
    ...
    ArrayList<details> mArrayList1=new ArrayList<details>();
    RecyclerView recyclerView;
    List<Resturant> mResturant;
    ArrayAdapterCardviewFavourite adapter_cardview;
    public static int fav_count=0;
    ImageView imageView_fav;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fav_grid_view);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_favspecific);
        ...
        recyclerView.addItemDecoration(new fav_grid_view.GridSpacingItemDecoration(2, dpToPx(10), true));
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                intent.putExtra("image",mArrayList1.get(position).getImage());
                intent.putExtra("Hotel_Name",mArrayList1.get(position).getHotel_name());
                intent.putExtra("Rating",mArrayList1.get(position).getRating());
                intent.putExtra("Number",mArrayListNumber.get(position).toString());
                intent.putExtra("Address",mArrayList1.get(position).getAddress());
    ...
    public void inflatingValues()
    {
        mResturant= mydb.getDataFav("true");
        ...
        for (int i = 0; i < mArrayListNames.size(); i++)
        {
            ...
            mArrayList1.add(details);
            System.out.println("Yash Shah in..."+image+"......."+Name+".....");
        }

        adapter_cardview=new ArrayAdapterCardviewFavourite(getApplicationContext(),mArrayList1);
